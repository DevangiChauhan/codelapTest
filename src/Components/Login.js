...
export default function Login() {
    ...
    return (
        <div className="card">
            <div className="form">
                <div className="title">
                    <p>Welcome to CodeLap network!</p>
                </div>
                {
                ...
                <div>
                    ...
                    <input type="text" name="email" placeholder="John Doe" value={params.email || ""} onChange={handleChange}/>
                    {
                ...
                <div>
                    ...
                    <input type="password" placeholder="********" name="password" value={params.password || ""} onChange={handleChange}/>
                    {
