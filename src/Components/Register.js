        ...
        <div className="card">
            <div className="form">
                ...
                <div>
                    ...
                    <input placeholder="Enter Name!" type="text" name="name" value={params.name || ""} onChange={handleChange}/>
                    {
                ...
                <div>
                    ...
                    <input type="text" placeholder="Enter Email!" name="email" value={params.email || ""} onChange={handleChange}/>
                    {
                ...
                <div>
                    ...
                    <input type="password" placeholder="Enter Password!" name="password" value={params.password || ""} onChange={handleChange}/>
                    {
